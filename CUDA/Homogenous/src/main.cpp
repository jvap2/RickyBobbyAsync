...
{  
    ...
    get_graph_info(POWER_GRAPH_DATA_PATH,&nodes,&edges);
    cout<<nodes<<endl;
    cout<<edges<<endl;
    edge* edge_list;
    ...
    CSR_Graph(POWER_GRAPH_EDGE_PATH,nodes, edges, src_ptr,succ,deg);
    ...
    return_edge_list(POWER_GRAPH_EDGE_PATH,edge_list);
